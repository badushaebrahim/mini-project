...
$id=$_GET['id'];
$q="select * from tbquestion where questionid='$id'";
...
<table>
	<tr>
		<td>Question</td>
                <td><textarea name="question"><?php echo $r[1];?></textarea></td>
	</tr>
	<tr>
		<td>Option 1</td>
                <td><textarea name="op1"><?php echo $r[2];?></textarea></td>
	</tr>
        <tr>
		<td>Option 2</td>
                <td><textarea name="op2"><?php echo $r[3];?></textarea></td>
	</tr>
        <tr>
		<td>Option 3</td>
                <td><textarea name="op3"><?php echo $r[4];?></textarea></td>
	</tr>
        <tr>
		<td>Option 4</td>
                <td><textarea name="op4"><?php echo $r[5];?></textarea></td>
	</tr>
        <tr>
		<td>Answer</td>
                <td><textarea name="answer"><?php echo $r[6];?></textarea></td>
	</tr>
	<tr>
		<td></td>
 ...
 if(isset($_REQUEST['btnsubmit']))
{
   ...
   $q="update tbquestion set question='$question',op1='$op1',op2='$op2',op3='$op3',op4='$op4',answer='$answer' where  questionid='$id';";
